          ...
          <div className="w-1/3 border-r border-gray-200 p-6">
            {shift ? (
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-4">Shift Details</h4>
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-sm font-medium text-gray-900">{shift.role_needed}</div>
                      {shift.required_skill && (
                        <div className="text-xs text-gray-500">Requires: {shift.required_skill}</div>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200">
                  <div className="text-sm">
                    ...
                    <div className="text-gray-900 font-semibold">${(Number(shift.pay_rate) || 0).toFixed(2)}/hour</div>
                  </div>
                  {shift.uniform_name && (
                    <div className="text-sm mt-3">
                      <div className="text-gray-500 mb-1">Uniform</div>
                      <div className="text-gray-900 font-medium">{shift.uniform_name}</div>
                    </div>
                  )}
                </div>
