...
echo "Creating 30 shifts for comprehensive testing (FIXED VERSION)..."
...
for i in {1..30}; do
  ...
  # Create the JSON with proper variable expansion
  json_data="{\"shift\": {\"client_name\": \"Bulk Test Hotel $i\", \"role_needed\": \"Server\", \"start_time_utc\": \"2025-10-${day}T14:00:00Z\", \"end_time_utc\": \"2025-10-${day}T22:00:00Z\", \"capacity\": 2, \"location\": \"Bulk Test St $i\", \"pay_rate\": 25.0, \"status\": \"published\"}}"
